...
const styles = {
  ...
  icon: [
    ...
    'data-[disabled]:opacity-50',
    // Icon
    '[&>[data-slot=icon]]:mx-0 [&>[data-slot=icon]]:my-0 [&>[data-slot=icon]]:size-5 [&>[data-slot=icon]]:shrink-0 [&>[data-slot=icon]]:text-[--btn-icon] [&>[data-slot=icon]]:sm:my-0 [&>[data-slot=icon]]:sm:size-4 forced-colors:[--btn-icon:ButtonText] forced-colors:data-[hover]:[--btn-icon:ButtonText]',
...
export const Button = forwardRef(function Button(
  ...
  let classes = icon
    ? clsx(className, styles.icon, styles.plain)
    : clsx(
        className,
        styles.base,
        outline
